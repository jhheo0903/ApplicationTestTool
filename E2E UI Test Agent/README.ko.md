...
| **GitHub Copilot** | GitHub 토큰 | GitHub Models API 사용, GitHub 계정 필요 |
...
GitHub Copilot 지원은 **GitHub Copilot API** (`api.githubcopilot.com`)를 OAuth Device Flow로 사용합니다. 토큰을 직접 복사·붙여넣기하거나 앱을 별도로 등록할 필요 없이 GitHub에서 로그인하면 Copilot 구독의 모델 목록을 자동으로 가져옵니다.
